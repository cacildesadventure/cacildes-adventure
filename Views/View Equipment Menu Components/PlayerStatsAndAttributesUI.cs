...
namespace AF.UI.EquipmentMenu
{
    public class PlayerStatsAndAttributesUI : MonoBehaviour
    {
        ...
        public void DrawStats(Item item)
        {
            ...
            int baseVitality = playerStatsBonusController.GetCurrentVitality();
            int baseEndurance = playerStatsBonusController.GetCurrentEndurance();
        ...
        {
            var currentPoise = playerManager.characterPoise.GetMaxPoiseHits();
